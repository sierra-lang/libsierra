...
static float varying(L) ceil(float varying(L)) { /* dummy */ return 0.f; }
static float varying(L) trunc(float varying(L)) { /* dummy */ return 0.f; }
static float varying(L) rint(float varying(L)) { /* dummy */ return 0.f; }
